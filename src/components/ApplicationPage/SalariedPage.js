...
export class Salaried extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            "name": "",
            ...
            "purposeOfLoan": "",
            "constituentOfCompany": "Private Limited",
            "experienceCurrentEmployer": "",
            "experienceOverallEmployer": ""
        };
    ...
    handleSubmit(event) {
        ...
        customer["experienceCurrentEmployer"] = parseInt(customer["experienceCurrentEmployer"])
        customer["experienceOverallEmployer"] = parseInt(customer["experienceOverallEmployer"])
                    ...
                    <Form encType="multipart/form-data" onSubmit={this.handleSubmit}>
                        ...
                        <Row>
                            ...
                            <Col sm={6}> <FormGroup controlId="formHorizontalNumberOfEmployees">
                                <Col componentClass={ControlLabel} sm={12}>
                                    <b  >Constituent of Company</b></Col>
                                <Col sm={12}>
                                    <select value={this.state.constituentOfCompany} className="col-sm-12 form-control" title="Constituent Of Company" name="constituentOfCompany" onChange={this.handleChange} required>
                        ...
                        <Row>
                            ...
                            <Col md={6}>
                                <FormGroup controlId="formHorizontalEmail">
                                    ...
                                    <Col sm={12}>
                                        <FormControl type="text" name="residOffStabilty" value={this.state.residOffStabilty} onChange={this.handleChange} pattern="\d{1,15}" required />
                                    </Col>
                                </FormGroup>
                            </Col>
                        </Row>
                        <Row>
                            <Col md={6}>
                                <FormGroup controlId="formHorizontalMobileNum">
                                    ...
                                    <Col sm={12}>
                                        <FormControl type="text" name="offStabilty" value={this.state.offStabilty} onChange={this.handleChange} pattern="\d{1,15}" required />
                                    </Col>
                                </FormGroup>
                        ...
                        <Row>
                            <Col md={6}>   <FormGroup controlId="formHorizontalNetSalary">
                                <Col componentClass={ControlLabel} sm={12}>
                                    <b  >Experience(Current Employer)</b></Col>
                                <Col sm={12}>
                                    <FormControl type="text" name="experienceCurrentEmployer" value={this.state.experienceCurrentEmployer} onChange={this.handleChange} pattern="\d{1,15}" required />
                                </Col>
                            </FormGroup></Col>
                            <Col md={6}>   <FormGroup controlId="formHorizontalNetSalary">
                                <Col componentClass={ControlLabel} sm={12}>
                                    <b  >Experience(Overall)</b></Col>
                                <Col sm={12}>
                                    <FormControl type="text" name="experienceOverallEmployer" value={this.state.experienceOverallEmployer} onChange={this.handleChange} pattern="\d{1,15}" required />
                                </Col>
                            </FormGroup></Col>
                        ...
                        <Row>
                            <Col sm={6}> <FormGroup controlId="formHorizontalOfficeAddress1">
                                ...
                                <Col sm={12}>
                                    <FormControl type="text" name="numberOfDependents" value={this.state.numberOfDependents} onChange={this.handleChange} pattern="\d{1,8}" required />
                                </Col>
                            </FormGroup></Col>
                            ...
                            <Col sm={6}> <FormGroup controlId="formHorizontalOfficeAddress1">
                                ...
                                <Col sm={12}>
                                    <select value={this.state.abb} className="col-sm-12 form-control" title="Abb" name="abb" onChange={this.handleChange} required>
                                        <option value=" > 2 times loan EMI"> Greater than 2 time</option>
                        ...
                        <Row>
                            <Col sm={6}> <FormGroup controlId="formHorizontalOfficeAddress1">
                                ...
                                <Col sm={12}>
                                    <FormControl type="text" name="netMonthlyIncome" value={this.state.netMonthlyIncome} onChange={this.handleChange} pattern="\d{1,15}" required />
                                </Col>
                            </FormGroup></Col>
                            <Col sm={6}>  <FormGroup controlId="formHorizontalOfficeAddress2">
                                <Col componentClass={ControlLabel} sm={12}>
                        ...
                        {/* <Row>
                            ...
                            <Col sm={6}> <FormGroup controlId="formHorizontalCity">
                                ...
                                <Col sm={12}>
                                    <FormControl type="text" name="carOwnership" onChange={this.handleChange} value={this.state.carOwnership} required />
                                </Col>
                            </FormGroup></Col>
                        </Row>
                        <Row>
                            ...
                            <Col sm={6}>  <FormGroup controlId="formHorizontalState">
                                <Col componentClass={ControlLabel} sm={12}>
                                    <b>Car Maker</b></Col>
                                <Col sm={12}>
                                    <FormControl type="text" name="carMaker" onChange={this.handleChange} value={this.state.carMaker} required />
                                </Col>
                            </FormGroup></Col>
                            <Col sm={6}> <FormGroup controlId="formHorizontalCity">
                                <Col componentClass={ControlLabel} sm={12}>
                                    <b  >Car Model</b></Col>
                                <Col sm={12}>
                                    <FormControl type="text" name="carModel" onChange={this.handleChange} value={this.state.carModel} required />
                                </Col>
                            </FormGroup></Col>
                        </Row> */}
                        <Row>
